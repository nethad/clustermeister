...
public abstract class AmazonEC2JPPFDeployer extends Observable {
    ...
    protected final String jppfConfigFileName;
    protected final String log4jConfigFileName;
    ...
    public AmazonEC2JPPFDeployer(LoginCredentials loginCredentials,
            ...
            String crc32File, String jppfConfigFileName, 
            String log4jConfigFileName, String startScript, 
        ...
        this.jppfConfigFileName = jppfConfigFileName;
    ...
    public String deploy() {
        ...
        try {
            ...
            setupJPPF();
            uploadConfiguration("JPPF Node Configuration generated by Clustermeister.", 
                    getSettings(), jppfConfigFileName);
            ...
            NodeConfigurationUtils.getLog4JConfiguration(
                    ...
                    nodeConfiguration.getDriverAddress(), 54321), //TODO: driver address may not be correct in a remote driver scenario! configurable port 
                    log4jConfigFileName);
    ...
    protected InputStream getRunningConfig(java.util.Properties properties, String comment) {
        StringWriter runningConfig = new StringWriter();
        try {
            properties.store(runningConfig, comment);
        } catch (IOException ex) {
            logger.warn("Can not write configuration: {}.", comment, ex);
        }

        return new ByteArrayInputStream(runningConfig.toString().
    ...
    protected void uploadConfiguration(String comment, Properties configuration, String destination) {
        logger.debug("Uploading config {}.", destination);
        upload(getRunningConfig(configuration, comment), 
                String.format("%s%s", getDirectoryName(), destination));
    }
