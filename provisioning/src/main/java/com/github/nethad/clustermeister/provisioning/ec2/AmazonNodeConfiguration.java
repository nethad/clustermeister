...
public class AmazonNodeConfiguration implements NodeConfiguration {
    ...
    private Optional<KeyPairCredentials> credentials = Optional.absent();
    ...
    public void setCredentials(KeyPairCredentials credentials) {
        this.credentials = Optional.fromNullable(credentials);
    }

    public Optional<KeyPairCredentials> getCredentials() {
        return credentials;
    }
