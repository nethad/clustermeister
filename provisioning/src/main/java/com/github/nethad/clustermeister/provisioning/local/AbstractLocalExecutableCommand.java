 ...
 * @author thomas
 */
public abstract class AbstractLocalExecutableCommand extends AbstractExecutableCommand {
    private final LocalCommandLineEvaluation commandLineEvaluation;

    public AbstractLocalExecutableCommand(String commandName, String[] arguments, String helpText, 
            LocalCommandLineEvaluation commandLineEvaluation) {
    ...
    protected LocalNodeManager getNodeManager() {
