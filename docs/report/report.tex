...
than the task execution time. The network overhead is increased additionally because the tasks are sent in small batches.
...
\caption{Short-running tasks}
\label{fig:evaluation-short-running}
\end{figure}
