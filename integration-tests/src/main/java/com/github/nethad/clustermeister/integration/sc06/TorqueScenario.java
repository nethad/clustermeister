 ...
 * @author thomas
 */
public class TorqueScenario {
    private ArrayList<String> report;
    private final Logger logger = LoggerFactory.getLogger(TorqueScenario.class);
    
    public static void main(String... args) {
        new TorqueScenario().execute();
    }
...
//					"Result is not as expected.");
    ...
    private void addToReport(String key, Object value) {
        report.add(String.format("[%s => %s]", key, value));
    }
